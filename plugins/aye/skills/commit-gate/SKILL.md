...
4 个互斥候选,**交互式选择工具可用时优先用工具呈现**(Claude Code: `AskUserQuestion`; Codex:可用工具;label 末尾 ` (Recommended)` 标推荐项,description 填 trade-off);不可用时 fallback 到下面文本列表:
...
3. 用户喊"今天到这 / 收 / 暂停 / handoff / context 满了 / 下次继续" → invoke / suggest `handoff`
